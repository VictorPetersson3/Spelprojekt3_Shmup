...
Studio::ShopUI::ShopUI()
{
	...
	myTier1Buttons.push_back(new ShopButton("Sprites/UI/ShopUI/shopUI_cards_tier1.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier1Upgrades::ShieldCooldown, 5, "Sprites/UI/ShopUI/ShieldCDT1.dds"));
	myTier1Buttons.push_back(new ShopButton("Sprites/UI/ShopUI/shopUI_cards_tier1.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier1Upgrades::ShieldDuration, 5, "Sprites/UI/ShopUI/ShieldDUT1.dds"));
	myTier1Buttons.push_back(new ShopButton("Sprites/UI/ShopUI/shopUI_cards_tier1.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier1Upgrades::ShieldHealth, 5, "Sprites/UI/ShopUI/ShieldHPT1.dds"));
	myTier1Buttons.push_back(new ShopButton("Sprites/UI/ShopUI/shopUI_cards_tier1.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier1Upgrades::BasicAttackSpeed, 5, "Sprites/UI/ShopUI/BasicAttackSpeedT1.dds"));
	...
	myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::BasicAttackAdditionalProjectile, 10, "Sprites/UI/ShopUI/BasicAttackPlusOneT2.dds"));
	...
	myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::ShieldCooldown, 10, "Sprites/UI/ShopUI/ShieldCDT2.dds"));
	myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::BasicAttackSpeed, 10, "Sprites/UI/ShopUI/BasicAttackSpeedT2.dds"));
	...
	myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::ShieldDuration, 10, "Sprites/UI/ShopUI/ShieldDUT2.dds"));
	myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::ShieldHealth, 10, "Sprites/UI/ShopUI/ShieldHPT2.dds"));

	myTier3Buttons.push_back(new ShopButtonTier3("Sprites/UI/ShopUI/shopUI_cards_tier3.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier3Upgrades::BasicAttackSpeed, 15, "Sprites/UI/ShopUI/BasicAttackSpeedT3.dds"));
	...
	myTier3Buttons.push_back(new ShopButtonTier3("Sprites/UI/ShopUI/shopUI_cards_tier3.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier3Upgrades::RapidFirePenetrating, 15, "Sprites/UI/ShopUI/RapidFirePENT3.dds"));
	myTier3Buttons.push_back(new ShopButtonTier3("Sprites/UI/ShopUI/shopUI_cards_tier3.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier3Upgrades::ShieldExplosion, 15, "Sprites/UI/ShopUI/ShieldT3.dds"));
