...
Studio::ShopUI::ShopUI()
{
		...
		myTier1Buttons.push_back(new ShopButton("Sprites/UI/ShopUI/shopUI_cards_tier1.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier1Upgrades::RapidFireAttackSpeed,5,"Rapid Fire Attack Speed Tier 1"));
		myTier1Buttons.push_back(new ShopButton("Sprites/UI/ShopUI/shopUI_cards_tier1.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier1Upgrades::RapidFireDuration,5, "Rapid Fire Duration Tier 1"));
		myTier1Buttons.push_back(new ShopButton("Sprites/UI/ShopUI/shopUI_cards_tier1.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier1Upgrades::RapidFireCooldown,5, "Rapid Fire Cooldown Tier 1"));
		...
		myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::MissileCooldown, 10, "Missile Cooldown Tier 2"));
		myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::MissileDamage, 10, "Missile Damage Tier 2"));
		myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::MissileExplosionRadius, 10, "Missile Explosion Radius Tier 2"));
		myTier2Buttons.push_back(new ShopButtonTier2("Sprites/UI/ShopUI/shopUI_cards_tier2.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 500000, Enums::Tier2Upgrades::RapidFireAttackSpeed, 10, "Rapid Fire Attack Speed Tier 2"));
		...
		myTier3Buttons.push_back(new ShopButtonTier3("Sprites/UI/ShopUI/shopUI_cards_tier3.dds", { 0,0 }, { 1,1 }, { 0.5f,0.5f }, 5000000, Enums::Tier3Upgrades::MissileCluster, 15, "Missile Cluster"));
